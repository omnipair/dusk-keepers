...
export interface ProtocolLock {
  ...
  readonly toolchain: Readonly<Record<"anchor" | "rust" | "solana" | "surfpool" | "node", string | null>>;
...
export interface DuskAdapter {
  readonly protocolRevision: string;
  buildInstruction(request: BuildRequest): Promise<InstructionIntent>;
}
